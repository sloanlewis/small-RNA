...
countemiR <- bplapply(bfl, function(x) summarizeOverlaps(eByg, x, mode="Union", ignore.strand=TRUE, inter.feature=TRUE, singleEnd=TRUE))
...
write.table(countDFmiR, "./results/countDFmiR.xls", col.names=NA, quote=FALSE, sep="\t")
